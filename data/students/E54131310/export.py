...
PLAYERS_DIR = Path(r"C:\Users\Murray\Documents\ai course\baseball-comic-obsidian\data\students\E54131310\vault\ai course\人物資料")
...
def main():
    ...
    data = {
        ...
        "players": load_md_files(PLAYERS_DIR),
